package net.mcreator.projectredo;
...
import net.mcreator.projectredo.init.ProjectRedoModPaintings;
...
@Mod("project_redo")
public class ProjectRedoMod {
	public static final Logger LOGGER = LogManager.getLogger(ProjectRedoMod.class);
	public static final String MODID = "project_redo";

	public ProjectRedoMod() {
		...
		ProjectRedoModPaintings.REGISTRY.register(bus);
		ProjectRedoModParticleTypes.REGISTRY.register(bus);

		ProjectRedoModMenus.REGISTRY.register(bus);
